...
export const metadata: Metadata = {
  ...
  description: "Join personalised one-to-one online classes for CBSE and ICSE students. Flexible schedules, expert tutors, and exam-focused learning.",
};
...
export default function Home() {
  const features = [
    {
      ...
      description: 'Each student receives a dedicated tutor and a customised lesson plan designed for their learning pace and goals.',
    },
    {
      icon: UserCheck,
      title: 'Individual Mentor',
      description: 'A mentor monitors progress, assigns practice, and shares regular feedback with parents to ensure steady improvement.',
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description: 'Tutors trained in CBSE and ICSE syllabuses for Classes KG - 12. Exam-oriented and concept-focused teaching.',
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: 'Verified tutors, secure video sessions, and child-friendly material ensure a safe learning environment.',
    },
  ];

  const testimonials = [
    {
      quote: "I am very satisfied with the classes provided by Cert-Ed Academia for my children. What I really appreciate is that Cert-Ed provides classes based on my children’s requirements and even on demand when they need extra support. The flexible schedules, supportive teachers, and one-on-one mentoring have helped my children develop more interest in their studies. The online classes also make learning very convenient for us.",
      author: "Fasal Punnassery",
      role: "Dubai Electricity and Water Authority, Dubai\nParent of Faadi (Class VII → VIII) & Aamil (Class I)\nCBSE | With us since 2024",
    },
    {
      quote: "My daughter is attending the online Arabic tuition, and we are very satisfied with the classes. The personal tutor gives good attention, and the personal mentor is very supportive. Takshvi enjoys the sessions and feels comfortable learning. We have seen good improvement in her Arabic marks as well.",
    ...
    },
    {
      ...
      role: "HSE Trainer, Qatar\nParent of Tamanna Class VII → X\nCBSE | With us since 2023",
    },
    {
      quote: "Classes were very good and useful for quickly studying the topics given in textbook. Mentors were nice and supported my children though their studies. Teachers were also nice and helped prepare for the examinations.",
      author: "Melby Mathew",
    ...
    {
      quote: "The classes were good. It really helped him understand the concepts. The teacher took the initiative to ensure he understood everything. Revisions and tests were also properly done to make sure that he was able to recollect the concepts.",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We serve students in India and all GCC countries including UAE, Saudi Arabia, Qatar, Kuwait, Oman and Bahrain.",
    },
    {
      question: "How long is a typical session?",
      answer: "Sessions are usually 1 hour or 1.5 hours. We customise session length based on age and learning needs. If required, the durations can be adjusted to the student needs.",
    },
    {
      question: "Do you follow the school syllabus and exam pattern?",
      answer: "Yes. All lessons are prepared strictly according to the latest board syllabus and exam pattern, ensuring students are well-prepared for school exams and board exams.",
    },
    {
      question: "How are teachers or mentors assigned to students?",
      answer: "Each student is assigned an individual mentor based on their class, subject, learning level, and specific academic needs.",
    },
    {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-white text-slate-900 py-8 px-4 md:py-12 overflow-hidden relative">
        ...
        {/* Soft light blue glow - Top Right */}
        ...
        {/* Soft light blue glow - Bottom Left */}
        ...
        {/* Soft light blue glow - Bottom Right */}
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-16 relative z-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-slate-800 mb-8 max-w-2xl mx-auto md:mx-0 leading-relaxed font-medium">
              <strong>Cert-Ed Academia</strong> provides individual attention, dedicated tutors, and flexible online classes
              for students across <strong>India & GCC</strong> (UAE, Saudi Arabia, Qatar, Kuwait, Oman, Bahrain).
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link
                href="/contact"
                className="!bg-[#124d7e] !text-white hover:!bg-[#0f365c] font-bold py-3 px-8 rounded-full transition-all shadow-lg flex items-center justify-center gap-2 text-base md:text-lg"
              >
      ...
      <SectionWrapper className="bg-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Our personalised classes focus on concept clarity, regular progress tracking, and parent communication — ideal for busy families in India and the Gulf.
          </p>
      ...
      <section className="bg-primary py-20 px-4 text-center text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl opacity-90 mb-10 max-w-2xl mx-auto">
            Experience our teaching style first-hand. A demo helps us understand your child's needs and match the right tutor.
          </p>

          <Link
            href="/contact"
            className="bg-white text-primary hover:bg-gray-100 font-bold py-4 px-12 rounded-full transition-all shadow-xl inline-flex items-center gap-2 text-lg"
          >
