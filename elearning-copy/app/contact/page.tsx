                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex bg-white rounded-lg border border-gray-300 focus-within:ring-2 focus-within:ring-primary focus-within:border-transparent transition-all overflow-hidden">
                                            <div className="flex items-center pl-3 pr-2 border-r border-gray-200 bg-gray-50">
                                                <select
                                                    id="countryCode"
                                                    value={formData.countryCode}
                                                    onChange={handleChange}
                                                    disabled={status === 'loading'}
                                                    className="bg-transparent border-none outline-none text-gray-700 text-sm focus:ring-0 cursor-pointer disabled:cursor-not-allowed font-medium pr-1"
                                                >
