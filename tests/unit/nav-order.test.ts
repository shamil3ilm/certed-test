...
describe('nav ordering by persona', () => {
  ...
  it('keeps the tutor main-nav order stable', () => {
    expect(labelsFor(['tutor'])).toEqual(['Dashboard', 'Classes', 'Grading', 'Messages', 'Calendar'])
  })
  ...
  it('keeps the mentor main-nav order stable', () => {
    ...
    expect(labelsFor(['mentor'])).toEqual(['Dashboard', 'Classes', 'Grading', 'Mentees', 'Messages', 'Calendar'])
  })
  ...
  it('keeps the student main-nav order stable', () => {
    expect(labelsFor(['student'])).toEqual(['Dashboard', 'Classes', 'Grading', 'Messages', 'Calendar'])
  })
