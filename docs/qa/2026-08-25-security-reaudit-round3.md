...
| **B-09, B-11, B-13, CSP `form-action`, CI token**                     | OPEN        | LOW     | `B-11` still `role: 'teacher'` — invalid enum since `0019`. **[Superseded 2026-08-26: fixed in `71be574`; see [round 4](./2026-08-26-security-reaudit-round4.md).]**                                                                                                                                               |
