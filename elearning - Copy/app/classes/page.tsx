            ...
            <SectionWrapper id="class-overview" className="bg-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {classLevels.map((level, index) => (
                        <div key={index} className="p-8 border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow bg-white">
            ...
            <SectionWrapper id="subjects" className="bg-primary rounded-b-[4rem] !py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
                    {subjects.map((subject, index) => (
                        <div key={index} className="bg-white px-6 py-6 rounded-lg shadow-md text-primary font-medium text-lg hover:shadow-lg transition-all cursor-default text-center flex items-center justify-center w-full h-full">
                            {subject}
                        </div>
                    ))}
                </div>
            ...
            <SectionWrapper id="how-it-works" className="bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    {steps.map((step, index) => (
                        <div key={index} className="relative p-6 bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
