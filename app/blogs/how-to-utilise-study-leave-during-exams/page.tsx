...
export const metadata: Metadata = {
  ...
  description: "Learn how to utilise study leave effectively with proper planning, revision techniques, and time management strategies.",
};
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <article className="prose prose-lg max-w-none text-gray-700 space-y-8 prose-headings:text-gray-900 prose-a:text-primary hover:prose-a:underline prose-li:marker:text-primary">
                        ...
                        <p className="text-xl leading-relaxed">
                            Board exams are not only about preparation before the exams begin. The study leave or exam gaps between two exams play a crucial role in improving performance. When used properly, these gaps can help students revise efficiently, reduce stress, and enter the exam hall with confidence.
                        </p>
                        ...
                        <h2 className="text-3xl font-bold mt-10 mb-6 text-primary">Introduction: Turning Exam Gaps into Opportunities</h2>

                        <p>
                            Exams test knowledge, but <strong>how to utilise study leave during exams</strong> often determines their final performance.
                        </p>
                        ...
                        <p className="bg-gray-50 border-l-4 border-gray-400 p-4 italic">
                            Using the same routine for all types of gaps can reduce productivity. Students should adjust their strategy based on the length of the gap.
                        </p>
                        ...
                        <p><strong className="text-gray-900">Goal:</strong> Maintain accuracy and improve answer presentation.</p>
                        ...
                        <div className="bg-primary/5 border-l-4 border-primary p-6 rounded-r-lg my-6">
                            ...
                            <p className="m-0">Avoid overstudying these subjects. Confidence and accuracy are more important than excessive revision.</p>
                        </div>

                        <h3 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">Moderate Difficulty Subjects</h3>
                        <p><strong className="text-gray-900">Goal:</strong> Improve concept clarity and formula retention.</p>
                        <p className="font-semibold text-gray-900 mt-4">What to focus on:</p>
                        <ul className="list-disc pl-6 space-y-2">
                        ...
                        <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 my-6">
                            ...
                            <p className="mb-4">Teach the answer aloud to yourself as if you are the teacher. This strengthens understanding and memory.</p>
                        ...
                        <p><strong className="text-gray-900">Goal:</strong> Reduce fear and increase accuracy.</p>
                        <p className="font-semibold text-gray-900 mt-4">What to focus on:</p>
                        <ul className="list-disc pl-6 space-y-2">
                        ...
                        <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg my-6">
                            ...
                            <p className="m-0 text-red-900">Accuracy is more important than quantity. One correct answer builds more confidence than several rushed attempts.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                <h3 className="text-xl font-bold text-secondary mb-4 flex items-center">☀️ Morning <span className="text-sm font-normal text-gray-500 ml-2">(High Focus Zone)</span></h3>
                            ...
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                <h3 className="text-xl font-bold text-secondary mb-4 flex items-center">🌤️ Afternoon <span className="text-sm font-normal text-gray-500 ml-2">(Low Energy Zone)</span></h3>
                                <ul className="list-disc pl-6 space-y-2 text-sm">
                            ...
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                <h3 className="text-xl font-bold text-secondary mb-4 flex items-center">🌆 Evening <span className="text-sm font-normal text-gray-500 ml-2">(Active Recall Zone)</span></h3>
                                <ul className="list-disc pl-6 space-y-2 text-sm">
                            ...
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                <h3 className="text-xl font-bold text-secondary mb-4 flex items-center">🌙 Night <span className="text-sm font-normal text-gray-500 ml-2">(Memory Lock Zone)</span></h3>
                                <ul className="list-disc pl-6 space-y-2 text-sm">
                        ...
                        <div className="bg-primary text-white p-6 rounded-xl text-center shadow-lg my-8">
                            ...
                            <p className="text-lg mb-0 font-medium tracking-wide">After every 90 minutes of focused study, take a 10–15 minute break.</p>
                        ...
                        <p className="font-medium text-gray-900 mt-4 italic text-center">A healthy body supports a calm mind and better academic performance.</p>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>Use positive self-talk such as: <span className="italic font-medium text-primary">“I am prepared and I will do my best.”</span></li>
                        </ul>
                        ...
                        <p>
                            <strong>How to utilise study leave during exams</strong> is not just about filling free time between papers. When used effectively, it becomes a powerful opportunity to revise smartly, strengthen weak areas, and build confidence.
                        </p>
                        ...
                        <p>
                            Students who follow a structured exam gap study plan often experience less stress and better results. Need extra help preparing? Our <Link href="/contact" className="font-medium">personalized online tuition</Link> classes can give you the structured guidance needed during study leave.
                        </p>
                    ...
                    <div className="mt-16 bg-gradient-to-br from-primary to-[#0f365c] rounded-2xl p-8 md:p-12 text-center text-white shadow-xl">
                        ...
                        <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
                            Need help clearing doubts right before your exams? Get instant support with our personalized one-to-one CBSE & ICSE sessions.
                        </p>
