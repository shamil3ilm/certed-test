    ...
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-slate-50 p-6">
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-slate-200 bg-white/90 p-8 text-center shadow-xl backdrop-blur">
        <Image
          ...
          priority
        />
        <h1 className="mt-6 text-lg font-semibold text-slate-900">Access revoked</h1>
        <p className="mt-2 text-sm text-slate-500">
          Your access has been revoked. Contact the academy if you think this is a mistake.
        </p>
        <LogoutForm className="mt-6 inline-block rounded-xl border border-primary/30 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/5">
          Back to sign in
        </LogoutForm>
      </div>
    </main>
