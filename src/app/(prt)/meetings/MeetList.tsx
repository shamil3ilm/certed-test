...
/** A scheduled meet is "ended" once its start plus this grace has passed - long
 *  enough to cover a full session, after which the Join button locks. */
const MEET_GRACE_MS = 3 * 60 * 60 * 1000

/** ISO instant -> a datetime-local input value ("YYYY-MM-DDTHH:mm") in device time. */
