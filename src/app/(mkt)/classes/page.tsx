...
export const metadata: Metadata = {
  ...
  description: "Explore personalised one-to-one classes, flexible timings, and curriculum designed for CBSE and ICSE students.",
};
...
export default function Classes() {
    const steps = [
        ...
        },
        {
            ...
            description: 'We assign an experienced CBSE/ICSE tutor and a mentor who oversees progress and communicates with parents.',
        },
        {
        ...
        },
        {
            ...
            description: 'Monthly reports, tests, and parent feedback calls ensure measurable improvement and plan adjustments.',
        },
    ];
    ...
    const classLevels = [
        {
            ...
            description: "Focus on reading, writing, arithmetic, and basic concepts through activity-based learning and frequent feedback."
        },
        {
        ...
        },
        {
            ...
            description: "Exam-focused teaching, sample paper practice, doubt clearing and chapter-wise assessments for CBSE & ICSE boards."
        },
        {
            title: "Classes 11–12 (Senior Secondary)",
            description: "Advanced subject tuition, stream-specific coaching (Science, Commerce, Humanities), and college-prep support if required."
        }
    ];
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="bg-white text-slate-900 py-10 px-4 text-center">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                    CBSE & ICSE (Classes KG - 12) — We offer structured, syllabus-aligned one-to-one classes that build strong fundamentals and exam readiness.
                </p>
            </section>
            ...
            <SectionWrapper id="class-overview" className="bg-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {classLevels.map((level, index) => (
                        <div key={index} className="p-8 border border-gray-100 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white group">
            ...
            <SectionWrapper id="subjects" className="bg-primary rounded-b-[4rem] !py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
                    {subjects.map((subject, index) => (
                        <div key={index} className="bg-white px-6 py-6 rounded-lg shadow-md text-primary font-medium text-lg hover:shadow-xl hover:-translate-y-1 hover:scale-105 transition-all duration-300 cursor-pointer text-center flex items-center justify-center w-full h-full">
                            {subject}
                        </div>
                    ))}
                </div>
            ...
            <SectionWrapper id="how-it-works" className="bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    {steps.map((step, index) => (
                        <div key={index} className="relative p-6 bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col h-full group">
