    ...
    const blogs = [
        {
            ...
            excerpt: "Learn the best CBSE board exam preparation tips using a 4-phase study strategy covering learning, practice, revision, and mock tests.",
            image: "https://placehold.co/600x400/124d7e/ffffff?text=CBSE+Prep",
            date: "March 15, 2026",
            category: "Exam Prep",
        ...
        },
        {
            ...
            excerpt: "Learn how to utilise study leave during board exams with a smart exam gap study plan including revision strategies, stress management, and health tips.",
            image: "https://placehold.co/600x400/4db1e2/ffffff?text=Study+Leave",
        ...
        },
        {
            ...
            excerpt: "Learn effective CBSE & ICSE answer writing tips to improve presentation, highlight keywords, structure answers clearly, and score higher.",
            image: "https://placehold.co/600x400/0f365c/ffffff?text=Answer+Writing",
