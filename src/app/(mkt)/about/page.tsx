...
export default function About() {
  return (
    <div className="flex min-h-screen flex-col">
      <section className="bg-slate-50 px-4 py-10 text-center text-slate-900">
      ...
      <SectionWrapper id="mission" className="bg-white">
        <div className="flex flex-col items-center gap-6 md:flex-row">
          ...
          <div className="flex flex-1 items-center justify-center rounded-3xl border border-slate-100 bg-gradient-to-br from-primary/5 to-secondary/10 p-8 shadow-sm md:p-12">
            <div className="text-center">
              <MARKETING_ABOUT_ICONS.team className="mx-auto mb-4 h-16 w-16 text-secondary" />
              <p className="text-2xl font-bold text-slate-800">Transforming Lives Through Education</p>
            </div>
          </div>
        </div>
      </SectionWrapper>

      <SectionWrapper id="vision" className="bg-slate-50">
      ...
      <SectionWrapper id="values" className="bg-white">
        <div className="mb-8 text-center">
          <h2 className="mb-4 text-3xl font-bold text-slate-900">Our Core Values</h2>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {MARKETING_VALUES.map((value) => (
            ...
            >
              ...
              <p className="font-medium text-slate-600">{value.description}</p>
            </div>
          ))}
        </div>
      </SectionWrapper>
        ...
        <div className="flex flex-col items-center gap-6 md:flex-row">
          ...
          <div className="flex-1">
            <div className="grid grid-cols-2 gap-4">
              <div className="flex h-full flex-col items-center justify-center rounded-xl border border-b-[6px] border-r-[6px] border-slate-200 bg-white p-6 text-center shadow-xl">
                <div className="mx-auto mb-3 flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-secondary/20">
                  <MARKETING_ABOUT_ICONS.tutor className="h-8 w-8 text-primary" />
                </div>
                <p className="font-bold text-slate-900">Friendly Tutors</p>
              </div>
              <div className="flex h-full flex-col items-center justify-center rounded-xl border border-b-[6px] border-r-[6px] border-slate-200 bg-white p-6 text-center shadow-xl">
                <div className="mx-auto mb-3 flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-secondary/20">
                  <MARKETING_ABOUT_ICONS.team className="h-8 w-8 text-primary" />
                </div>
                <p className="font-bold text-slate-900">Dedicated Mentors</p>
              </div>
            </div>
          </div>
        </div>
