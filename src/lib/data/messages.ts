...
/** Remove every participant row for a conversation (best-effort cleanup after a
...
/** Hard-delete a conversation row when creation failed before the thread became
 *  real for users (no first message committed). */
