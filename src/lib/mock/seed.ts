...
export function buildSeed(): MockDb {
  return {
    ...
    resource_comments: [
      {
        id: 'rcm00000-0000-4000-8000-000000000001',
        resource_id: 'r0000000-0000-4000-8000-000000000001',
        author_id: IDS.student,
        content: 'Teacher, is chapter 4 completely covered in this PDF?',
        created_at: NOW,
      },
      {
        id: 'rcm00000-0000-4000-8000-000000000002',
        resource_id: 'r0000000-0000-4000-8000-000000000001',
        author_id: IDS.teacher,
    ...
    meet_comments: [
      {
        id: 'mcm00000-0000-4000-8000-000000000001',
        meet_link_id: 'ml000000-0000-4000-8000-000000000001',
        author_id: IDS.student,
        content: 'Should we join this link 5 minutes before scheduled time?',
        created_at: NOW,
      },
      {
        id: 'mcm00000-0000-4000-8000-000000000002',
        meet_link_id: 'ml000000-0000-4000-8000-000000000001',
        author_id: IDS.teacher,
