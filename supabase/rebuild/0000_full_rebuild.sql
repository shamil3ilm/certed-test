...
-- migrations (supabase/migrations/0001..0091) applied in order. The numbered
...
\restrict pghzeMX8EH2WNFlNJXYaPchnvEEPMT8fnMsgfh8Di4tMNGkowj3T2uuVSh4KQh3
...
--      REVOKE after the column GRANTs wipes them. Revoking first, then letting the ACL
--      GRANTs below re-establish the columns, mirrors the chain.
...
-- Generated by scripts/rebuild-snapshot.sh; asserted by tests/unit/snapshot-privilege-epilogue.
-- ============================================================================
...
\unrestrict pghzeMX8EH2WNFlNJXYaPchnvEEPMT8fnMsgfh8Di4tMNGkowj3T2uuVSh4KQh3
