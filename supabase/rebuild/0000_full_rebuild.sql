...
-- ============================================================================
-- GENERATED from the numbered migrations (supabase/migrations/0001..0095) via
...
\restrict BOyjLcy40sGXICpPt0S9mm2tRwIucOZdsap738bYGZ1SQMaaODsmpVpLawizTn5
...
COMMENT ON TABLE public.class_sessions IS 'One row per RECORDED session. A class may have several on the same date; id is the session identifier. Attendance remains per (class, student, date).';
...
\unrestrict BOyjLcy40sGXICpPt0S9mm2tRwIucOZdsap738bYGZ1SQMaaODsmpVpLawizTn5
